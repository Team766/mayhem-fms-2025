...
func TestRankingsCsvReport(t *testing.T) {
	...
	expectedBody := "Rank,TeamId,RankingPoints,MatchPoints,AutoPoints,EndgameKrakenLairPoints,Wins,Losses," +
		"Ties,Disqualifications,Played\n1,254,20,625,90,40,3,2,1,0,10\n2,1114,18,700,100,50,1,3,2,0,10\n\n"
